...
const DataRow = styled.tr`
  border-top: 1px solid ${({ theme }) => theme.customColors.border.primary};
  border-bottom: 1px solid ${({ theme }) => theme.customColors.border.primary};
`;
